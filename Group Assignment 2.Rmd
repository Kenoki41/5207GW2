...
---
Our team select median_age_persons, median_rent_weekly, median_tot_prsnl_inc_weekly as independent variables and the propbabilty of each party as the dependent variable.We will examine the relationship between the independent variable and dependent variable.weekly room rent and weekly personal income may affect the election probability results of different parties. 
