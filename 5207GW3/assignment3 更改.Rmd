...
covid.with.county.map <- covid.with.county.map %>%
  mutate(tot_cases2 = cut(tot_cases, breaks=c(0, 100, 1000, 10000, 100000, 1000000),labels=c("0-100","100-1000","1000-10000","10000-100000","100000-1000000"), include.lowest=TRUE))
