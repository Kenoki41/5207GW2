...
=======
>>>>>>> 0b1630da4dd8eb6ac469a0657b5b156ffe727acb
...
eco_g <- ggplot(data = covid.with.count.data) + 
=======
```{r Rename columns}
...
>>>>>>> 0b1630da4dd8eb6ac469a0657b5b156ffe727acb
  geom_bar(
    mapping = aes(x = economic_type, color = factor(economic_type)), #清洗后用病例数对应观察分布
    show.legend = FALSE,
    width = 1,
    na.rm = TRUE
  ) + 
